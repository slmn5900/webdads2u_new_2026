        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 xl:gap-16 relative">
          ...
          >
            <div className="flex items-center gap-3 mb-4 md:mb-8">
              ...
              <p className="uppercase tracking-widest text-sm font-medium text-gray-300">
                Our Services
              </p>
            </div>
              ...
              {serviceCategories?.map((cat, idx) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`relative flex items-center gap-4 text-left w-full transition-all ${
                      active
                        ? "text-white"
                  ...
                  >
                    ...
                    <h3
                      className={`text-4xl md:text-5xl font-light leading-7 md:leading-12 ${
                        active
            ...
            <AnimatePresence mode="wait">
              {!isDetailMode ? (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -30 }}
                  className="rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 p-8 lg:p-10 min-h-[500px]"
                >
                  <ul>
                    {currentCategory.items.map((item) => (
                      <motion.li
                        ...
                        className="py-4  rounded-xl cursor-pointer transition-colors group flex gap-3 items-center text-lg md:text-2xl"
                        whileHover={{ x: 6 }}
                      >
                        <span>{item.name}</span>
                        <span
                ...
                >
                  <div className="flex items-center gap-4 mb-10">
                    <button
                      ...
                      className="text-4xl text-purple-400 hover:text-purple-300 transition-transform hover:-translate-x-2"
                    >
                      ←
                    </button>
